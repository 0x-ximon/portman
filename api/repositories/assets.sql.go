...
VALUES ($1, $2, $3, $4)
RETURNING id, name, symbol, decimals, asset_class, created_at, updated_at, deleted_at
`
...
SELECT id, name, symbol, decimals, asset_class, created_at, updated_at, deleted_at FROM assets
